      ...
      <div class="card-body">
        ...
        <div class="text-center mb-8">
          <div class="avatar mb-4">
            <div
              class="w-16 h-16 bg-gradient-to-r from-primary to-secondary rounded-full flex items-center justify-center">
        ...
        <form @submit.prevent="handleLogin" class="space-y-6">
          ...
          <!-- Login Button -->
          <button type="submit" class="btn btn-primary w-full glass" :class="{ 'loading': authStore.isLoading }"
        ...
        <div class="text-center mt-6 text-sm text-base-content/70">
          <p>© 2024 Horizon. Todos los derechos reservados.</p>
        </div>
      </div>
    </div>
  </AuthLayout>
