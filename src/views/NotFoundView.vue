<template>
  <ErrorLayout>
    <!-- Error Icon -->
    <div class="mb-8">
      <div class="w-32 h-32 mx-auto bg-error/20 rounded-full flex items-center justify-center">
    ...
    <!-- Sugerencias -->
    <div class="bg-base-200/50 rounded-lg p-6 mb-8 max-w-md mx-auto">
      <h3 class="font-semibold mb-3">¿Qué puedes hacer?</h3>
