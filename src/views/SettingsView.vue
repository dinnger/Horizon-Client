          ...
          <div class="card-body">
            ...
            <div class="form-control mb-4">
              ...
              <div class="grid grid-cols-2 md:grid-cols-3 gap-4">
                <div v-for="theme in themes" :key="theme.value" @click="settingsStore.setTheme(theme.value)" :class="[
                  'p-4 rounded-lg border-2 cursor-pointer transition-all hover:shadow-md',
                  settingsStore.currentTheme === theme.value ? 'border-primary bg-primary/10' : 'border-base-300'
                ]">
...
// Map icons to components for themes
...
// Update themes to use actual components
const themes = settingsStore.availableThemes.map(theme => ({
  ...theme,
  icon: iconComponents[theme.icon as keyof typeof iconComponents]
}))

const tabs = [
  { id: 'general', label: 'General', icon: IconSettings },
  { id: 'workspaces', label: 'Workspaces', icon: IconProjects },
  { id: 'account', label: 'Cuenta', icon: IconSupport },
  { id: 'privacy', label: 'Privacidad', icon: IconSettings },
  { id: 'about', label: 'Acerca de', icon: IconSupport }
]
